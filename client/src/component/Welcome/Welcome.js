                            ...
                            <div className="job-box">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="salary">
                                        <span><i className="fas fa-rupee-sign"></i> 20000 - <i className="fas fa-rupee-sign"></i> 30000</span>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div className="job-box">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="salary">
                                        <span><i className="fas fa-rupee-sign"></i> 30000 - <i className="fas fa-rupee-sign"></i> 40000</span>
                                    </div>
                                    <label className="wishlist">
                                        <input type="checkbox"/><span className="added">
                                          <BiHeart size={28} style={{width:"26px"}}/>
                        ...
                        <li>
                            <div className="job-box">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="salary">
                                        <span><i className="fas fa-rupee-sign"></i> 35000 - <i className="fas fa-rupee-sign"></i> 45000</span>
                                    </div>
                                    <label className="wishlist">
                                        <input type="checkbox"/><span className="added">
                                          <BiHeart size={28} style={{width:"26px"}}/>
                        ...
                        <li>
                            <div className="job-box">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="salary">
                                        <span><i className="fas fa-rupee-sign"></i> 35000 - <i className="fas fa-rupee-sign"></i> 40000</span>
                                    </div>
                                    <label className="wishlist">
                                        <input type="checkbox"/><span className="added">
                                          <BiHeart size={28} style={{width:"26px"}}/>
